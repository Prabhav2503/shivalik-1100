...
export default function AdminMessMenu() {
  ...
  const saveChanges = async () => {
    ...
    try {
      ...
      const dayIndex = updatedMenu.menu.findIndex((day: IDayMenu) => day.day === editingDay);
      
      if (dayIndex === -1) return;
      
      // Update the specific meal
      updatedMenu.menu[dayIndex].meals[editingMeal as keyof IMeal] = filteredItems;
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-4" style={{backgroundColor:"rgb(38,38,38)"}}>
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-blue-500 my-6">Admin - Mess Menu Management</h1>
        
        <div className="grid grid-cols-1 gap-6">
          {messMenu.menu.map((day) => (
            <div key={day.day} className="bg-gray-800 p-4 rounded-lg" style={{backgroundColor:"rgb(64,64,64)"}}>
              <h2 className="text-xl font-semibold text-white mb-4">{day.day}</h2>
              
              {/* Breakfast */}
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  <h3 className="text-lg font-medium text-blue-400">Breakfast</h3>
                  {editingDay === day.day && editingMeal === "breakfast" ? (
                    ...
                    <button
                      onClick={() => startEditing(day.day, "breakfast", day.meals.breakfast)}
              ...
              <div className="mb-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  {editingDay === day.day && editingMeal === "lunch" ? (
                    ...
                    <button
                      onClick={() => startEditing(day.day, "lunch", day.meals.lunch)}
                      className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-md text-sm"
                    >
                      Edit
                    </button>
              ...
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  {editingDay === day.day && editingMeal === "dinner" ? (
                    ...
                    <button
                      onClick={() => startEditing(day.day, "dinner", day.meals.dinner)}
                      className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded-md text-sm"
                    >
                      Edit
                    </button>
